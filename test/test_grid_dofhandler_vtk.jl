...
#                        (11)
    ...
    @test getneighborhood(topology,hexgrid,EdgeIndex(3,6),true) == [EdgeIndex(4,8),EdgeIndex(3,6)]
    @test getneighborhood(topology,hexgrid,EdgeIndex(1,1),true) == [EdgeIndex(1,1)]
    @test getneighborhood(topology,hexgrid,EdgeIndex(2,4),true) == [EdgeIndex(1,2),EdgeIndex(2,4)]
